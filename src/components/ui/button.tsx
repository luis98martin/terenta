  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground active:bg-destructive/90 rounded-xl shadow-md",
        outline:
          "border-2 border-input bg-background active:bg-accent active:text-accent-foreground rounded-xl",
        secondary:
          "bg-secondary text-secondary-foreground active:bg-secondary/80 rounded-xl shadow-md",
        ghost: "active:bg-accent/10 active:text-accent rounded-xl",
        ...
        "header-mustard": "bg-white text-[hsl(var(--brand-red,0_71%_38%))] active:bg-white/90 rounded-xl shadow-sm font-semibold",
        ...
        "brand-hero": "bg-[hsl(var(--brand-red,0_71%_38%))] text-white active:bg-[hsl(var(--brand-red,0_71%_33%))] rounded-xl shadow-md font-bold text-base",
        "brand-outline": "border-2 border-[hsl(var(--brand-red,0_71%_38%))] text-[hsl(var(--brand-red,0_71%_38%))] bg-transparent active:bg-[hsl(var(--brand-red,0_71%_38%))] active:text-white rounded-xl shadow-sm",
